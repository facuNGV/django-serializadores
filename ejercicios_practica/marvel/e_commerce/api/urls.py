...
urlpatterns = [
    ...
    path('{{URL}}/e-commerce/api/users/list/', UserListAPIView.as_view(), name= "user_class_list_api_view"),
    path('{{URL}}/e-commerce/api/users/<username>/', UserRetrieveAPIView.as_view(), name= "user_class_retrieve_api_view"),
    # TODO: Wish-list Class API View.
    path('{{URL}}/e-commerce/api/wish/list-create/', WishListAPIView.as_view(), name= "wishlist_class_api_view"),
]
